/*
    ************** Formal Definition: ***************
    ...
    that allows an object to capture its internal state and restore it later without violating encapsulation. 
    It is especially useful when implementing features like undo/redo or rollback.


    ************* Key Components of Memento Pattern: *************
    This pattern defines three key components:
    1. Originator: The object whose internal state we want to save and restore.
    2. Memento: A storage object that holds the snapshot of the originator’s state.
    3. Caretaker: The object responsible for requesting the memento and keeping track of it. 
        It neither modifies nor examines the contents of the memento.

    **************  Real-Life Analogy: Undo/Redo in Text Editors ***************
    Think of the Memento Pattern as an undo/redo mechanism.
    When you type or edit something in a text editor, 
    ...
    and the editor (originator) can revert to these snapshots when needed, 
